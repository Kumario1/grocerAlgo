...
- Files: `router/` (engine + pipeline), `app.py` (web app), `docs/archive/store_router.py` (Phase-0 prototype), `data/<N>/` (store truth), `guide-*.pdf` (source directories), `docs/evidence/` (vector-ingestion deliverables).
